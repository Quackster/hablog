...
Public Sub ShowLimitsTab()
    ...
    frmSettings.limitsLabel6.Caption = GetLocaleString("limitsLabel6")
    frmSettings.limitsLabel7.Caption = GetLocaleString("limitsLabel7")
    frmSettings.limitsLabel8.Caption = GetLocaleString("limitsLabel8")
